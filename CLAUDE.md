...
The game creates tension through multiple systems:
1. **Time Pressure**: Increasing speed multipliers per round (1x → 3x)
2. **Score Tradeoff**: Spending score on upgrades reduces total score
3. **Upgrade Strategy**:
   - Early consumables (time bonuses) help reach later rounds
   - Expensive permanent upgrades require saving across rounds
   - Cost scaling (1.5x per purchase) limits spam
4. **Combo Mechanics**: Cascades reward skillful play with multipliers and bonus time

The game represents a complete, polished Match-3 experience with:
- **Engaging progression** across 10 rounds of increasing difficulty
- **Strategic depth** through the shop and upgrade system
- **Smooth animations** and responsive design
- **Cohesive cosmic alien theme** throughout all assets and UI